...
def fetch_historical_data(symbols: List[str], lookback_days: int = 180) -> Dict[str, pd.DataFrame]:
    """
    Fetch historical OHLCV data for multiple symbols using yfinance
    ...
    start_date = end_date - timedelta(days=lookback_days + 50)  # Extra buffer for indicator calculation
